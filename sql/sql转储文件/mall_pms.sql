...
CREATE TABLE `pms_attr`  (
  ...
  INDEX `idx_pms_attr_catelog_id`(`catelog_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '上市年份', 0, 0, 'xxx', '2018;2019;2020;2021', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (2, '上市月份', 0, 0, 'xx', '1;2', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (3, '颜色', 0, 1, 'LJL', '黑色;白色;蓝色', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (4, '内存', 0, 1, 'LJL', '4G;6G;8G;12G', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (5, '首销日期', 0, 0, 'xxx', '1;2', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (6, '入网型号', 0, 0, 'xxx', '1;2', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (7, '机身宽度', 0, 0, 'LJL', '100;110', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (8, '机身厚度', 0, 0, 'LJL', '20;25', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (12, '机身重量', 0, 0, 'xxx', '100g;110g;120g', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (13, '产品名称', 0, 0, 'xxx', '', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (14, '机身材质工艺', 0, 0, 'xxx', '陶瓷;金属;玻璃;铝合金', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (15, '机身颜色', 0, 0, 'xxx', '黑色;白色', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (16, 'CPU品牌', 1, 0, 'xxx', '高通;思科;联发科;苹果', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (17, 'CPU型号', 1, 0, 'xxx', 'A10;A11;A12;A13', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (18, '版本', 0, 1, 'xxx', '8+128;8+256;4+128;4+256;8+512', 0, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (20, '测试基本属性1111', 0, 1, '1', '1', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (21, '测试基本属性2', 0, 1, 'xx', '2', 1, 1, 225, 0);
INSERT INTO `pms_attr` VALUES (22, '测试销售属性', 0, 1, 'xx', '1', 0, 1, 225, 0);
...
CREATE TABLE `pms_attr_attrgroup_relation`  (
  ...
  INDEX `idx_pms_attr_attrgroup_relation_attr_id`(`attr_id`) USING BTREE,
  INDEX `idx_pms_attr_attrgroup_relation_attr_group_id`(`attr_group_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (9, 1, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 6, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (11, 2, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (12, 5, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (13, 7, 8, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (14, 8, 8, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (21, 10, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (22, 11, 8, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (23, 9, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (24, 12, 8, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (25, 13, 1, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (26, 14, 8, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (27, 15, 8, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (28, 16, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (29, 17, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (32, 20, 10, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (33, 21, 10, NULL);
...
CREATE TABLE `pms_attr_group`  (
  ...
  INDEX `idx_pms_attr_group_catelog_id`(`catelog_id`) USING BTREE,
  INDEX `idx_pms_attr_group_attr_group_name`(`attr_group_name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (1, '主体', 1, '1', '1', 225);
INSERT INTO `pms_attr_group` VALUES (8, '基本信息', 1, '1', '1', 225);
INSERT INTO `pms_attr_group` VALUES (9, '主芯片', 1, '1', '1', 225);
INSERT INTO `pms_attr_group` VALUES (10, '测试', 1, '测试', 'xx', 225);
...
CREATE TABLE `pms_brand`  (
  ...
  INDEX `idx_pms_brand_name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (6, '华为', 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-15/1e4aaa26-6c15-4cec-8f11-9f5a65353a31_huawei.png', '华为', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (7, '小米', 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-15/16aa17f6-4af1-4964-862a-af47112ceb64_xiaomi.png', '小米', 1, 'X', 1);
INSERT INTO `pms_brand` VALUES (8, '苹果', 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-15/bcd6a353-6c8b-4afa-81ff-c278f815685e_apple.png', '苹果', 1, 'P', 1);
INSERT INTO `pms_brand` VALUES (9, 'OPPO', 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-15/4cdfe5e5-691f-4791-8e24-d7bd7f42f6bb_oppo.png', 'OPPO', 1, 'O', 1);
INSERT INTO `pms_brand` VALUES (10, 'VIVO', 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2022-04-25/92c6f209-526d-4328-895c-74dbb431eda1_vivo-logo.png', 'VIVO', 1, 'V', 1);
...
CREATE TABLE `pms_category`  (
  ...
  INDEX `idx_pms_category_parent_cid`(`parent_cid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1478 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品三级分类' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_category` VALUES (1472, '无线电', 34, 3, 1, 0, '1', '个', NULL);
INSERT INTO `pms_category` VALUES (1475, '测试分类test', 0, 1, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (1476, '测试分类的二级分类1', 1475, 2, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (1477, '测试分类的第二个二级分类1', 1475, 2, 0, 0, '', '', 0);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_pms_category_brand_relation_brand_id`(`brand_id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (3, 6, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (4, 6, 250, '华为', '平板电视');
INSERT INTO `pms_category_brand_relation` VALUES (5, 7, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (6, 8, 225, '苹果', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (7, 9, 225, 'OPPO', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (8, 10, 225, 'VIVO', '手机');
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  INDEX `idx_spu_id_attr_value`(`spu_id`, `attr_value`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 221 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (56, 3, 1, '上市年份', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (57, 3, 2, '上市月份', '4', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (58, 3, 5, '首销日期', '2021.4.21', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (59, 3, 6, '入网型号', 'OCE-AN10', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (60, 3, 13, '产品名称', 'HUAWEI Mate 40', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (61, 3, 7, '机身宽度', '72.5', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (62, 3, 8, '机身厚度', '9.2', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (63, 3, 12, '机身重量', '184', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (64, 3, 14, '机身材质工艺', '陶瓷', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (65, 3, 16, 'CPU品牌', '海思（Hisilicon）', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (66, 3, 17, 'CPU型号', '麒麟9000E', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (155, 6, 1, '上市年份', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (156, 6, 2, '上市月份', '12', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (157, 6, 5, '首销日期', '2020.12.1', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (158, 6, 6, '入网型号', '以官网信息为准', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (159, 6, 13, '产品名称', '小米手机', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (160, 6, 7, '机身宽度', '74.6', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (161, 6, 8, '机身厚度', '8.06', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (162, 6, 12, '机身重量', '196', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (163, 6, 14, '机身材质工艺', '玻璃后盖', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (164, 6, 16, 'CPU品牌', '高通(Qualcomm)', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (165, 6, 17, 'CPU型号', '骁龙888', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (166, 7, 1, '上市年份', '2021', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (167, 7, 2, '上市月份', '4', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (168, 7, 5, '首销日期', '1', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (169, 7, 6, '入网型号', 'PEEM00', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (170, 7, 13, '产品名称', 'OPPO Find X3 Pro', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (171, 7, 7, '机身宽度', '74.0', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (172, 7, 8, '机身厚度', '8.26', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (173, 7, 12, '机身重量', '193', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (174, 7, 14, '机身材质工艺', '以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (175, 7, 16, 'CPU品牌', '高通(Qualcomm)', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (176, 7, 17, 'CPU型号', '高通骁龙 888', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (210, 2, 1, '上市年份', '2020', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (211, 2, 2, '上市月份', '9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (212, 2, 5, '首销日期', '2020.9.15', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (213, 2, 6, '入网型号', 'A2404', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (214, 2, 13, '产品名称', 'apple iphone 12', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (215, 2, 7, '机身宽度', '71.5', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (216, 2, 8, '机身厚度', '7.4', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (217, 2, 12, '机身重量', '162', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (218, 2, 14, '机身材质工艺', '其他', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (219, 2, 16, 'CPU品牌', '苹果', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (220, 2, 17, 'CPU型号', 'A13', NULL, 0);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_pms_sku_images_sku_id`(`sku_id`) USING BTREE
...
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//98c64bc9-f21f-47c0-882b-a69714e8ebcd_黑色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (2, 2, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//98c64bc9-f21f-47c0-882b-a69714e8ebcd_黑色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (3, 3, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//4df6f866-24fd-4261-81dc-a300a3ef9c1b_白色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (4, 4, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//4df6f866-24fd-4261-81dc-a300a3ef9c1b_白色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (5, 5, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//5f0453b6-a59d-4b54-8f1b-fc372d1a5f21_蓝色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (6, 6, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//5f0453b6-a59d-4b54-8f1b-fc372d1a5f21_蓝色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (7, 7, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//f864b931-dcda-4a63-8ab9-091f390de25a_红色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (8, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//f864b931-dcda-4a63-8ab9-091f390de25a_红色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (9, 9, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//bc41738d-92f1-4dd9-8994-f430a7799a93_抹茶.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (10, 10, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//bc41738d-92f1-4dd9-8994-f430a7799a93_抹茶.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (11, 11, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//a00520c0-df36-4a05-86ba-6a8fa4a6b0e3_黑色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (12, 12, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//a00520c0-df36-4a05-86ba-6a8fa4a6b0e3_黑色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (13, 13, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//cbf5c6e9-f134-47e9-8878-95dc022800cb_夏日胡杨.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (14, 14, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//cbf5c6e9-f134-47e9-8878-95dc022800cb_夏日胡杨.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (15, 15, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//dbba9ff6-381a-464a-8db7-796c847c072e_蓝色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (16, 16, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//dbba9ff6-381a-464a-8db7-796c847c072e_蓝色.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (17, 17, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//5057ed14-ee33-4e89-86f5-933418099d70_烟紫.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (18, 18, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//5057ed14-ee33-4e89-86f5-933418099d70_烟紫.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (19, 19, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//2f071829-38d9-49cd-8fac-1b52e324b5f0_宇宙摩卡.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (20, 20, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//2f071829-38d9-49cd-8fac-1b52e324b5f0_宇宙摩卡.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (21, 21, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//7a69abfc-22ab-41f7-8518-1b553893d011_雾蓝.png', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (22, 22, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//7a69abfc-22ab-41f7-8518-1b553893d011_雾蓝.png', NULL, 1);
...
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (1, 2, 'Apple iPhone 12 黑色 128GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//98c64bc9-f21f-47c0-882b-a69714e8ebcd_黑色.png', 'Apple iPhone 12 黑色 128GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (2, 2, 'Apple iPhone 12 黑色 256GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//98c64bc9-f21f-47c0-882b-a69714e8ebcd_黑色.png', 'Apple iPhone 12 黑色 256GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 7599.0000, 0);
INSERT INTO `pms_sku_info` VALUES (3, 2, 'Apple iPhone 12 白色 128GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//4df6f866-24fd-4261-81dc-a300a3ef9c1b_白色.png', 'Apple iPhone 12 白色 128GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (4, 2, 'Apple iPhone 12 白色 256GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//4df6f866-24fd-4261-81dc-a300a3ef9c1b_白色.png', 'Apple iPhone 12 白色 256GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 7599.0000, 0);
INSERT INTO `pms_sku_info` VALUES (5, 2, 'Apple iPhone 12 蓝色 128GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//5f0453b6-a59d-4b54-8f1b-fc372d1a5f21_蓝色.png', 'Apple iPhone 12 蓝色 128GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (6, 2, 'Apple iPhone 12 蓝色 256GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//5f0453b6-a59d-4b54-8f1b-fc372d1a5f21_蓝色.png', 'Apple iPhone 12 蓝色 256GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 7599.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 2, 'Apple iPhone 12 红色 128GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//f864b931-dcda-4a63-8ab9-091f390de25a_红色.png', 'Apple iPhone 12 红色 128GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 2, 'Apple iPhone 12 红色 256GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//f864b931-dcda-4a63-8ab9-091f390de25a_红色.png', 'Apple iPhone 12 红色 256GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 7599.0000, 0);
INSERT INTO `pms_sku_info` VALUES (9, 2, 'Apple iPhone 12 绿色 128GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//bc41738d-92f1-4dd9-8994-f430a7799a93_抹茶.png', 'Apple iPhone 12 绿色 128GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 6799.0000, 0);
INSERT INTO `pms_sku_info` VALUES (10, 2, 'Apple iPhone 12 绿色 256GB', NULL, 225, 8, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//bc41738d-92f1-4dd9-8994-f430a7799a93_抹茶.png', 'Apple iPhone 12 绿色 256GB支持移动联通电信5G 双卡双待手机', '【领券立减800元！】加799元享价值1246元AirPods蓝牙耳机！更多优惠', 7599.0000, 0);
INSERT INTO `pms_sku_info` VALUES (11, 3, '华为 HUAWEI Mate 40 亮黑色 8GB+128GB', NULL, 225, 6, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//a00520c0-df36-4a05-86ba-6a8fa4a6b0e3_黑色.png', '华为 HUAWEI Mate 40 亮黑色 8GB+128GB麒麟9000E SoC芯片 5000万超感知徕卡电影影像 有线无线双超级快充', '【华为Mate40】后置三摄非凡影像!!!有线无线双超级快充AI隔空滑屏，限量抢购更多选择猛戳', 4999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 3, '华为 HUAWEI Mate 40 亮黑色 8GB+256GB', NULL, 225, 6, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//a00520c0-df36-4a05-86ba-6a8fa4a6b0e3_黑色.png', '华为 HUAWEI Mate 40 亮黑色 8GB+256GB麒麟9000E SoC芯片 5000万超感知徕卡电影影像 有线无线双超级快充', '【华为Mate40】后置三摄非凡影像!!!有线无线双超级快充AI隔空滑屏，限量抢购更多选择猛戳', 5499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (13, 3, '华为 HUAWEI Mate 40 秋日胡杨 8GB+128GB', NULL, 225, 6, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//cbf5c6e9-f134-47e9-8878-95dc022800cb_夏日胡杨.png', '华为 HUAWEI Mate 40 秋日胡杨 8GB+128GB麒麟9000E SoC芯片 5000万超感知徕卡电影影像 有线无线双超级快充', '【华为Mate40】后置三摄非凡影像!!!有线无线双超级快充AI隔空滑屏，限量抢购更多选择猛戳', 4999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (14, 3, '华为 HUAWEI Mate 40 秋日胡杨 8GB+256GB', NULL, 225, 6, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//cbf5c6e9-f134-47e9-8878-95dc022800cb_夏日胡杨.png', '华为 HUAWEI Mate 40 秋日胡杨 8GB+256GB麒麟9000E SoC芯片 5000万超感知徕卡电影影像 有线无线双超级快充', '【华为Mate40】后置三摄非凡影像!!!有线无线双超级快充AI隔空滑屏，限量抢购更多选择猛戳', 5499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (15, 6, '小米11 蓝色 8GB+128GB', NULL, 225, 7, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//dbba9ff6-381a-464a-8db7-796c847c072e_蓝色.png', '小米11 蓝色 8GB+128GB5G 骁龙888 2K AMOLED四曲面柔性屏 1亿像素 55W有线闪充 50W无线闪充 8GB+256GB 蓝色 游戏手机', '小米11享白条12期免息,骁龙888处理器,AMOLED柔性屏【小米11ultra限时享12期免息戳】', 3999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (16, 6, '小米11 蓝色 8GB+256GB', NULL, 225, 7, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//dbba9ff6-381a-464a-8db7-796c847c072e_蓝色.png', '小米11 蓝色 8GB5G 骁龙888 2K AMOLED四曲面柔性屏 1亿像素 55W有线闪充 50W无线闪充 8GB+256GB 蓝色 游戏手机+256GB', '小米11享白条12期免息,骁龙888处理器,AMOLED柔性屏【小米11ultra限时享12期免息戳】', 4299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 6, '小米11 烟紫(素皮) 8GB+128GB', NULL, 225, 7, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//5057ed14-ee33-4e89-86f5-933418099d70_烟紫.png', '小米11 烟紫(素皮) 8GB+128GB5G 骁龙888 2K AMOLED四曲面柔性屏 1亿像素 55W有线闪充 50W无线闪充 8GB+256GB 蓝色 游戏手机', '小米11享白条12期免息,骁龙888处理器,AMOLED柔性屏【小米11ultra限时享12期免息戳】', 3999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 6, '小米11 烟紫(素皮) 8GB+256GB', NULL, 225, 7, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//5057ed14-ee33-4e89-86f5-933418099d70_烟紫.png', '小米11 烟紫(素皮) 8GB+256GB5G 骁龙888 2K AMOLED四曲面柔性屏 1亿像素 55W有线闪充 50W无线闪充 8GB+256GB 蓝色 游戏手机', '小米11享白条12期免息,骁龙888处理器,AMOLED柔性屏【小米11ultra限时享12期免息戳】', 4299.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 7, 'OPPO Find X3 Pro 宇宙摩卡 8GB+256GB', NULL, 225, 9, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//2f071829-38d9-49cd-8fac-1b52e324b5f0_宇宙摩卡.png', 'OPPO Find X3 Pro 宇宙摩卡 8GB+256GB骁龙888 5000万双主摄IMX766 10亿色臻彩屏 60倍显微镜 12+256GB 宇宙摩卡 5G拍照旗舰手机', '【5.8OPPOFindX3Pro享12期免息日付低至16.7元|赠10000mAh充电宝|30天无忧退】', 5499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 7, 'OPPO Find X3 Pro 宇宙摩卡 12GB+256GB', NULL, 225, 9, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//2f071829-38d9-49cd-8fac-1b52e324b5f0_宇宙摩卡.png', 'OPPO Find X3 Pro 宇宙摩卡 12GB+256GB骁龙888 5000万双主摄IMX766 10亿色臻彩屏 60倍显微镜 12+256GB 宇宙摩卡 5G拍照旗舰手机', '【5.8OPPOFindX3Pro享12期免息日付低至16.7元|赠10000mAh充电宝|30天无忧退】', 5999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (21, 7, 'OPPO Find X3 Pro 雾蓝 8GB+256GB', NULL, 225, 9, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//7a69abfc-22ab-41f7-8518-1b553893d011_雾蓝.png', 'OPPO Find X3 Pro 雾蓝 8GB+256GB骁龙888 5000万双主摄IMX766 10亿色臻彩屏 60倍显微镜 12+256GB 宇宙摩卡 5G拍照旗舰手机', '【5.8OPPOFindX3Pro享12期免息日付低至16.7元|赠10000mAh充电宝|30天无忧退】', 5499.0000, 0);
INSERT INTO `pms_sku_info` VALUES (22, 7, 'OPPO Find X3 Pro 雾蓝 12GB+256GB', NULL, 225, 9, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//7a69abfc-22ab-41f7-8518-1b553893d011_雾蓝.png', 'OPPO Find X3 Pro 雾蓝 12GB+256GB骁龙888 5000万双主摄IMX766 10亿色臻彩屏 60倍显微镜 12+256GB 宇宙摩卡 5G拍照旗舰手机', '【5.8OPPOFindX3Pro享12期免息日付低至16.7元|赠10000mAh充电宝|30天无忧退】', 5999.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_attr_id_attr_name_attr_value`(`attr_id`, `attr_name`, `attr_value`) USING BTREE,
...
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 18, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 3, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 18, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 3, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 18, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 4, 3, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 18, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 5, 3, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 5, 18, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 6, 3, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 6, 18, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 7, 3, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 7, 18, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 8, 3, '颜色', '红色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 8, 18, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 9, 3, '颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 9, 18, '版本', '128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 10, 3, '颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 10, 18, '版本', '256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 11, 3, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 11, 18, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 12, 3, '颜色', '亮黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 12, 18, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 13, 3, '颜色', '秋日胡杨', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 13, 18, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 14, 3, '颜色', '秋日胡杨', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 14, 18, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 15, 3, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 15, 18, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 16, 3, '颜色', '蓝色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 16, 18, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 17, 3, '颜色', '烟紫(素皮)', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 17, 18, '版本', '8GB+128GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 18, 3, '颜色', '烟紫(素皮)', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 18, 18, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 3, '颜色', '宇宙摩卡', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 19, 18, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 3, '颜色', '宇宙摩卡', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 20, 18, '版本', '12GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (41, 21, 3, '颜色', '雾蓝', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (42, 21, 18, '版本', '8GB+256GB', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (43, 22, 3, '颜色', '雾蓝', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (44, 22, 18, '版本', '12GB+256GB', NULL);
...
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (6, 2, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//4df6f866-24fd-4261-81dc-a300a3ef9c1b_白色.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (7, 2, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//98c64bc9-f21f-47c0-882b-a69714e8ebcd_黑色.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (8, 2, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//f864b931-dcda-4a63-8ab9-091f390de25a_红色.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (9, 2, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//5f0453b6-a59d-4b54-8f1b-fc372d1a5f21_蓝色.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (10, 2, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//bc41738d-92f1-4dd9-8994-f430a7799a93_抹茶.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (11, 3, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//a00520c0-df36-4a05-86ba-6a8fa4a6b0e3_黑色.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (12, 3, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//cbf5c6e9-f134-47e9-8878-95dc022800cb_夏日胡杨.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (17, 6, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//dbba9ff6-381a-464a-8db7-796c847c072e_蓝色.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (18, 6, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//5057ed14-ee33-4e89-86f5-933418099d70_烟紫.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (19, 7, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//7a69abfc-22ab-41f7-8518-1b553893d011_雾蓝.png', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (20, 7, NULL, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//2f071829-38d9-49cd-8fac-1b52e324b5f0_宇宙摩卡.png', NULL, NULL);
...
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (2, 'Apple iPhone 12', 'Apple iPhone 12', 225, 8, 0.3200, 1, '2021-04-20 16:54:16', '2021-04-25 19:31:01');
INSERT INTO `pms_spu_info` VALUES (3, '华为 HUAWEI Mate 40', '华为 HUAWEI Mate 40', 225, 6, 0.5400, 1, '2021-04-21 14:45:09', '2021-04-25 19:31:11');
INSERT INTO `pms_spu_info` VALUES (6, '小米11', '小米11', 225, 7, 0.3640, 1, '2021-04-25 23:38:38', '2021-04-25 23:50:38');
INSERT INTO `pms_spu_info` VALUES (7, 'OPPO Find X3 Pro', 'OPPO Find X3 Pro', 225, 9, 0.6350, 1, '2021-05-08 11:54:43', '2021-05-08 11:57:30');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (2, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//85d07be5-224a-4915-8379-77e5d7627664_介绍1.png,https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//3cf96526-d1bf-498a-80c5-c49a14a78983_介绍2.png');
INSERT INTO `pms_spu_info_desc` VALUES (3, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//05207535-e5d6-4a1c-8039-07077adecaff_主1.png,https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-21//5c47562c-11f2-489e-8b4a-7aa222f41e0f_主2.png');
INSERT INTO `pms_spu_info_desc` VALUES (6, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//5a572edf-a6ec-4b91-820e-9f9880af1e9f_主1.png,https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-04-25//ccaefe3e-1795-412a-8bcd-d1ec6b806361_主2.png');
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://mall-ljl.oss-cn-beijing.aliyuncs.com/2021-05-08//145c3160-300e-4735-89fd-d59b1c7fb4db_datu.png');
